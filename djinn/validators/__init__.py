...
def load_validator(validator_type: str, category: str = "insecure"):
    """
    ...
    try:
        module_path = f"djinn.validators.{category}.{validator_type}"
        return importlib.import_module(module_path)
    except ImportError as e:
        raise ImportError(f"Could not load {category} validator '{validator_type}': {e}") 