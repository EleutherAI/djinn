...
def validate(problem, submission_code: str, test_cases: List[Tuple] = None) -> VerificationResultSingle:
    ...
    try:
        ...
        return _validate_with_secure_runner(problem, submission_code, test_cases, order_dependent)
...
def _validate_with_secure_runner(problem, submission_code: str, test_cases, order_dependent):
